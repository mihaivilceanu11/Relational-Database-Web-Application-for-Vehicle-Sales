...
<head>
	    <meta charset = "UTF-8">
	    <title> Selected sold vehicles </title>
...
<?php
    ...
    <table class="center">
      ...
      session_start();
        ...
        $manufacturer_sold = $_GET['manufacturer_sold'];
        ...
        WHERE P.Denumire = '$manufacturer_sold' AND A.ID_Auto IN (SELECT ID_Auto FROM factura)";
