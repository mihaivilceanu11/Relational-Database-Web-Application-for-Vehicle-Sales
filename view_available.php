...
<?php
    ...
    <table class="center">
      ...
      <?php
        ...
        WHERE A.ID_Auto NOT IN (SELECT ID_Auto FROM factura)";
      ...
      <tr>
        ...
        <td><?php echo $Price; echo'$'?></td>
        <td><a class="btn" href="view_available.php?del=<?php echo $ID_Auto;?>" onclick="return confirm('Are you sure?')">Delete</a></td>
